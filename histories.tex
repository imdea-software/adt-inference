...
\end{verbatim}
  ...
  only label method argument and return values for illustrative purposes only;
...
\begin{verbatim}
    ...
    [4:_] read*     (RO)      #
\end{verbatim}
  Operation~$3$ is unmatched, and Operation~$4$ is pending.
...
\begin{example}
  ...
  The histories of the Executions of Example~\ref{ex:executions} are
\begin{verbatim}
    [1:1] write(a)        #
    [2:2] write(b)          #
    [3:1] read => a (RO)      #
\end{verbatim}
  in which all three operations are sequential,
\begin{verbatim}
    [1:1] write(a)        #
    [2:2] write(b)        #
    [3:1] read => a (RO)    #
\end{verbatim}
  in which the first two operations overlap, and
\begin{verbatim}
    [1:1] write(a)        #
    [2:2] write(b)          #
    [3:1] read => a (RO)    #
\end{verbatim}
  ...
  TODO SAY SOMETHING INTERESTING IN THIS EXAMPLE
\end{example}
