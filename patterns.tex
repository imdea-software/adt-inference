...
%and that the bounded complement of their kernel has 
%sets of histories
%%adhere to a well-founded ordering under the relation induced by such removals.
%have 
%a finite set of minimal elements with respect to the relation induced by such removals.
...
\begin{lemma}\label{lem:ADT_closure}
