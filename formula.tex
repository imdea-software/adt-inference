...
which represent the complement of a given ADT~\footnote{The complement of the kernel of an ADT $A$ is simply called the complement of $A$.}, we represent the ADT itself as
...
\begin{lemma}\label{lem:formula2}
...
%which is the complement of $Cl(M)$. 
