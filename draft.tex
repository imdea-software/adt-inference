...
\begin{abstract}
  ...
  symbolic, logical representations. Such representations are however difficult
  to obtain. Common practice is to design reference implementations.

  In this work we demonstrate that effective symbolic ADT representations can
  be automatically extracted from the executions of reference implementations.
  ...
  executions up to a small number of operations, we extract concise symbolic
  ADT representations which are complete in practice.
